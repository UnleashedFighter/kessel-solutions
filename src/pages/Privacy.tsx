...
const Privacy = () => {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO
        title="Privacy Policy | Kessel Solutions"
        description="Read Kessel Solutions’ privacy policy and how we collect, use, and protect your information."
        canonical="https://kesselsolutions.netlify.app/privacy"
      />
